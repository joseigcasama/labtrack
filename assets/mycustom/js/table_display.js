    ...
    },
    {
      ...
      message:
        '<center><h4 style="margin-top:-40px;">REPUBLIC OF THE PHILIPPINES</h4>\
						<h5>DON JOSE ECLEO MEMORIAL COLLEGE</h5>\
...
var table_equipment_print = $(".table_equipment_print").DataTable({
  ajax: {
    url: "../class/display/display",
    type: "POST",
    data: {
      key: "display_equipment_print",
    },
  },
  columns: [
    {
  ...
  columns: [
    ...
    },
    {
      ...
      render: function (data) {
        const wrapper = `
          <div class="status">
          <span>${data.damage} Damage</span>
          <span>${data.lost} Lost</span>
          <span>${data.unreturn} Un-Return</span>
          </div>`;
        return wrapper;
      },
    }
...
function room_info_borrow(a, b) {
  var table_roominfo_borrow = $(".table_roominfo_borrow").DataTable({
    ajax: {
      url: "../class/display/display",
      type: "POST",
      data: {
        key: "display_roominfo_borrow",
        id: b,
        name: a,
      },
    },
...
var tbl_borrow_pending = $(".tbl_borrow_pending").DataTable({
  ajax: {
    url: "../class/display/display",
    type: "POST",
    data: {
      key: "display_borrow_pending",
    },
  },
  columns: [
    {
    ...
    },
    {
      ...
      customize: function (win) {
        $(win.document.body)
          .find("table")
          .append(
            '<br<br/><br><h4 class="">Noted by:</h4><br><br><br><h4 class="">Prepared by:</h4>',
          );
      },
    },
  ],
