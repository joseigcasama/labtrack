...
<div class="col-sm-9 col-lg-10 col-md-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-3 main">
  ...
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Pending Borrowed Items</li>
    </ol>
  </div>
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body">
          <table class="table table-bordered tbl_borrow_pending" style="width:100%;">
            <thead>
              <tr>
                <th>Borrow Code</th>
                <th>Borrow Date</th>
...
<script type="text/javascript">
  function popup(url) {
    popupWindow = window.open(url, 'popUpWindow',
      "height=700,width=500,left=50,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes"
    )
  }
</script>
<!--  -->
