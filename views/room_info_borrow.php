	...
	<div class="col-sm-9 col-lg-10 col-md-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-3 main">
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="">Borrowed Items</li>
				<li class=""><a href="room">Rooms</a></li>
			    <li class="active"><?php echo strtoupper($_GET['name']); ?></li>
			</ol>
		</div><!--/.row-->
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<table class="table table-bordered table_roominfo_borrow" style="width:100%;">
							<thead>
								<tr>
									<th>Borrow Code</th>
									<th>Borrow Date</th>
